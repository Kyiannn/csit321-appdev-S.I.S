...
* 
* @returns {Object} { register, handleChange, handleSubmit, errorMessage }
*/
...
function useRegister() {
    ...
    /** Update form field and clear errors */
    ...
    /** Validate, submit registration, navigate to login on success */
    ...
    return { register, handleChange, handleSubmit, errorMessage }
}
